 ...
 */
function zenshade_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['zenshade_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('zenshade sample setting'),
  '#default_value' => theme_get_setting('zenshade_example'),
